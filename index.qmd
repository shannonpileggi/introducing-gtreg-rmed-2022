...
df_adverse_events |> 
  ...
  modify_spanning_header(
    # I _just_ learned this, but you can use '  \n' as a linebreaker that is 
    # recognized by HTML output in gt (need to test the other output formats),
    # but this would also work with flextable and kableExtra.
    # not 100% sure how the two spaces in front of  \n will render in the other formats?
...
df_adverse_events |> 
  ...
  modify_spanning_header(
    all_ae_cols(TRUE, TRUE) ~ "**{strata}**<br> N = {n}"
    ) |> 
  bold_labels()
```
...
<!-- the screenshot of the PDF output was blurry for me -->
````{verbatim}
---
output: pdf_document
---
